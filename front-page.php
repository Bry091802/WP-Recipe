   ...
   <!-- BANNER -->
      ...
      <div class="container">
        <div class="banner__wrapper">
          <div class="banner__details">
            ...
            <a href="./singlepage.html" class="btn bg--dark"><?php the_field('banner_button') ?></a>
          </div>
    ...
    if ($newQuery->have_posts()) : while($newQuery->have_posts()) : $newQuery->the_post();
        ?>
          ...
          <div class="food">
            <div class="food__img">
              <!-- <img src="./recipe/images/mac&cheese.jpeg" alt="" /> -->
               <?php 
            ...
            <div class="food__text">
              ...
              <li><a href="<?php the_permalink()?>">
                <button href="" class="btn bg--dark">Read More</button></a></li>
            </div>
          </div>
    ...
    <!-- CTA -->
    <section class="cta" style="background: linear-gradient(rgba(90, 88, 88, 0.5), rgba(90, 88, 88, 0.5)), 
    url('<?php the_field('cta_bg_url') ?>'); background-repeat:no-repeat; background-size:cover;">
      <div class="container">
